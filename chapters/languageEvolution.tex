...
\ic{Function}, which name is prefixed with \emph{test\_}, 
...
The debugger extension expects for \ic{Testcase} to lift a stack
frame whose name is prefixed with \emph{test\_} (see
\sect{CallStackDebuggerDef}). However, this frame is not present and therefore
