...
\section{Debugger Extension for MUnit Language}

This section describes the implementation of a debugger extension
for \emph{MUnit} language. This extension is defined with mbeddr's
debugger specification \ac{DSL} and the abstractions of the debugging
meta-model is shown in \fig{specabs}.
