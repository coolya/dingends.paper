...
\subsection{Breakpoints}  We want to be able to set breakpoints on instances of
...
\subsection{Stepping} As described in \sect{mbeddrDebuggerFramework}, stepping is
...
\subsection{Watches} \ic{ExecuteTestExpression} is translated to C 
